...
- [ ] **2. Redesign the desktop navigation rail (TDD)**
  ...
  - Make the shell full width from `top: 0`; use a hero translucent profile and a denser translucent compact profile; keep logo/link targets and the mobile rail unchanged.
  - First update focused tests, then implement and run the focused file plus build.

- [ ] **3. Replace hard scene seams with authored bridges (TDD)**
...
- [ ] **4. Add subtle desktop scene-edge continuity**
...
- [ ] **5. Independent review and browser evidence**
